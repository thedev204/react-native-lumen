...
export const TourTooltip = /*#__PURE__*/memo(() => {
  ...
  const dynamicStyles = useMemo(() => getDynamicStyles(config?.tooltipStyles), [config?.tooltipStyles]);
  ...
  if (currentStepData.renderCustomCard) {
    return /*#__PURE__*/_jsx(AnimatedView, {
      ...
      children: currentStepData.renderCustomCard(cardProps)
    });
  }
  ...
  return /*#__PURE__*/_jsxs(AnimatedView, {
    ...
    children: [/*#__PURE__*/_jsxs(View, {
      ...
      style: styles.footer,
      children: [!isLast && !isRequired && /*#__PURE__*/_jsx(TouchableOpacity, {
        onPress: stop,
        style: dynamicStyles.buttonText,
        children: /*#__PURE__*/_jsx(Text, {
          style: dynamicStyles.skipText,
          children: labelSkip
        })
      }), (isLast || isRequired) && /*#__PURE__*/_jsx(View, {
        style: styles.spacer
      }), /*#__PURE__*/_jsx(TouchableOpacity, {
        onPress: isNextDisabled ? undefined : next,
        disabled: isNextDisabled,
        style: [dynamicStyles.buttonPrimary, isNextDisabled && styles.disabledButton],
        children: /*#__PURE__*/_jsx(Text, {
          style: [dynamicStyles.primaryButtonText, isNextDisabled && styles.disabledButtonText],
          children: labelNext
        })
      })]
    })]
