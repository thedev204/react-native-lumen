...
export const TourProvider = ({
  ...
  }, [getOrderedSteps, animateToStep, isPersistenceEnabled, storageAdapter, autoResume, tourId, maxAge]);
  ...
  }, [currentStep, getOrderedSteps, stop, opacity, backdropOpacity, isPersistenceEnabled, clearOnComplete, storageAdapter, tourId]);
  ...
  const value = useMemo(() => ({
    ...
    clearProgress,
    hasSavedProgress
  }), [start, stop, next, prev, registerStep, unregisterStep, updateStepLayout, currentStep, targetX, targetY, targetWidth, targetHeight, targetRadius, opacity, spotlightBorderWidth, steps, config, containerRef, scrollViewRef, setScrollViewRef, currentSpotlightStyle, clearProgress, hasSavedProgress]);
